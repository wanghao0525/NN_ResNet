...
def conv2d(input, output_dim, k_h=1, k_w=3, d_h=1, d_w=1, stddev=0.02, name="conv2d"):
...
def deconv2d(input, output_shape, k_h=5, k_w=5, d_h=2, d_w=2, stddev=0.02, name="deconv2d"):
    with tf.variable_scope(name):
...
def linear(input, output_size, scope=None, stddev=0.02, bias_start=0.001):
